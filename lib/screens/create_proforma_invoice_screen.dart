...
class CreateProformaInvoiceScreen extends StatefulWidget {
  const CreateProformaInvoiceScreen({super.key});

  @override
  State<CreateProformaInvoiceScreen> createState() => _CreateProformaInvoiceScreenState();
}

class _CreateProformaInvoiceScreenState extends State<CreateProformaInvoiceScreen> {
      ...
      child: Row(
        ...
        children: [
          InkWell(
            ...
            child: _buildTopInfo(
                'PI Date', DateFormat('d-MM-yyyy').format(_quotationDate)),
          ),
          _buildTopInfo('PI Prefix', 'N/A'),
          _buildTopInfo('PI No.', '1', alignEnd: true),
        ],
      ),
    );
  }
